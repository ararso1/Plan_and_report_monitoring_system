...
function Sector() {
  ...
  const handleEdit = async (e) => {
    ...
    dispatch(
      editSelectedSectorData({ editName, editPhone, editEmail, editSectorId })
    );
    ...
    <>
                          ...
                          <tr key={items.id}>
                            ...
                            <td className="px-5 py-2 border-b-2 border-blue-gray-50">
                              <div className="flex items-center justify-center gap-2">
                                {authInfo.user.userPermissions.includes('updateSector') ? (
                                  <Button
                                    variant="text"
                                    size="sm"
                                ...
                                {authInfo.user.userPermissions.deleteSector ? (
                                  <Button
                                    variant="text"
                                    size="sm"
      ...
      <Dialog open={open} handler={handleOpen} size="sm">
        <DialogHeader className="flex justify-between">
          <div className="text-xl ml-5">Add New Sector</div>
      ...
      <Dialog open={openEdit} handler={handleOpenEdit} size="sm">
        <DialogHeader className="flex justify-between">
          <div className="text-xl ml-5">Update Sector</div>
